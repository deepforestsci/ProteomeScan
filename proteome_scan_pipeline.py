...
proteome_scan.run_pose_analysis : Pose analysis with fpocket
"""
...
def run_pipeline(config_file: str, sdf_dir: str) -> None:
    ...
    proteome_scan.run_pose_analysis : Pocket coverage analysis
                ...
                for complex_file in complexes_dir.glob(f"complex_{gene_name_analysis}_*_{ligand_name_analysis}.pdb"):
                    ...
                    if len(parts) >= 3:
                        ...
                        result: Optional[Dict[str, Any]] = run_pose_analysis(
                            str(complex_file), str(results_dir), gene_name_analysis, pdb_id_analysis, ligand_name_analysis
                        )
                        if result:
